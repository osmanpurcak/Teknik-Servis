...
namespace Ticari_Otomasyon {
    ...
    public partial class DboTicariOtomasyonDataSet3 : global::System.Data.DataSet {
        ...
        public partial class TBL_PERSONELLERDataTable : global::System.Data.TypedTableBase<TBL_PERSONELLERRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TBL_PERSONELLERRow AddTBL_PERSONELLERRow(string AD, string SOYAD, string TELEFON, string TC, string MAIL, string ADRES, string GOREV) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TBL_PERSONELLERRow FindByID(short ID) {
        ...
        public partial class TBL_PERSONELLERRow : global::System.Data.DataRow {
            ...
            public short ID {
                get {
                    return ((short)(this[this.tableTBL_PERSONELLER.IDColumn]));
                }
                set {
...
namespace Ticari_Otomasyon.DboTicariOtomasyonDataSet3TableAdapters {
    ...
    public partial class TBL_PERSONELLERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[TBL_PERSONELLER] ([AD], [SOYAD], [TELEFON], [TC], [MAIL], [ADRES], [GOREV]) VALUES (@AD, @SOYAD, @TELEFON, @TC, @MAIL, @ADRES, @GOREV);
SELECT ID, AD, SOYAD, TELEFON, TC, MAIL, ADRES, GOREV FROM TBL_PERSONELLER WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[TBL_PERSONELLER] SET [AD] = @AD, [SOYAD] = @SOYAD, [TELEFON] = @TELEFON, [TC] = @TC, [MAIL] = @MAIL, [ADRES] = @ADRES, [GOREV] = @GOREV WHERE (([ID] = @Original_ID) AND ((@IsNull_AD = 1 AND [AD] IS NULL) OR ([AD] = @Original_AD)) AND ((@IsNull_SOYAD = 1 AND [SOYAD] IS NULL) OR ([SOYAD] = @Original_SOYAD)) AND ((@IsNull_TELEFON = 1 AND [TELEFON] IS NULL) OR ([TELEFON] = @Original_TELEFON)) AND ((@IsNull_TC = 1 AND [TC] IS NULL) OR ([TC] = @Original_TC)) AND ((@IsNull_MAIL = 1 AND [MAIL] IS NULL) OR ([MAIL] = @Original_MAIL)) AND ((@IsNull_ADRES = 1 AND [ADRES] IS NULL) OR ([ADRES] = @Original_ADRES)) AND ((@IsNull_GOREV = 1 AND [GOREV] IS NULL) OR ([GOREV] = @Original_GOREV)));
SELECT ID, AD, SOYAD, TELEFON, TC, MAIL, ADRES, GOREV FROM TBL_PERSONELLER WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, AD, SOYAD, TELEFON, TC, MAIL, ADRES, GOREV FROM dbo.TBL_PERSONELLER";
        ...
        public virtual int Delete(short Original_ID, string Original_AD, string Original_SOYAD, string Original_TELEFON, string Original_TC, string Original_MAIL, string Original_ADRES, string Original_GOREV) {
        ...
        public virtual int Insert(string AD, string SOYAD, string TELEFON, string TC, string MAIL, string ADRES, string GOREV) {
            if ((AD == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_GOREV == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((string)(Original_GOREV));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string AD, string SOYAD, string TELEFON, string TC, string MAIL, string ADRES, string GOREV, short Original_ID, string Original_AD, string Original_SOYAD, string Original_TELEFON, string Original_TC, string Original_MAIL, string Original_ADRES, string Original_GOREV) {
            return this.Update(AD, SOYAD, TELEFON, TC, MAIL, ADRES, GOREV, Original_ID, Original_AD, Original_SOYAD, Original_TELEFON, Original_TC, Original_MAIL, Original_ADRES, Original_GOREV, Original_ID);
        }
    }
