...
namespace Ticari_Otomasyon {
    ...
    public partial class DboTicariOtomasyonDataSet : global::System.Data.DataSet {
        ...
        public partial class TBL_FIRMALARDataTable : global::System.Data.TypedTableBase<TBL_FIRMALARRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TBL_FIRMALARRow AddTBL_FIRMALARRow(string AD, string YETKILISTATU, string YETKILIADSOYAD, string YETKILITC, string SEKTOR, string TELEFON1, string TELEFON2, string TELEFON3, string MAIL, string FAX, string IL, string VERGIDAIRE) {
            ...
            private void InitClass() {
                ...
                this.columnSEKTOR.MaxLength = 13;
...
namespace Ticari_Otomasyon.DboTicariOtomasyonDataSetTableAdapters {
    ...
    public partial class TBL_FIRMALARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[TBL_FIRMALAR] ([AD], [YETKILISTATU], [YETKILIADSOYAD], [YETKILITC], [SEKTOR], [TELEFON1], [TELEFON2], [TELEFON3], [MAIL], [FAX], [IL], [VERGIDAIRE]) VALUES (@AD, @YETKILISTATU, @YETKILIADSOYAD, @YETKILITC, @SEKTOR, @TELEFON1, @TELEFON2, @TELEFON3, @MAIL, @FAX, @IL, @VERGIDAIRE);
SELECT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON2, TELEFON3, MAIL, FAX, IL, VERGIDAIRE FROM TBL_FIRMALAR WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBL_FIRMALAR] SET [AD] = @AD, [YETKILISTATU] = @YETKILISTATU, [YETK" +
                ...
                "AIL, [FAX] = @FAX, [IL] = @IL, [VERGIDAIRE] = @VERGIDAIRE WHERE (([ID] = @Origin" +
                "al_ID) AND ((@IsNull_AD = 1 AND [AD] IS NULL) OR ([AD] = @Original_AD)) AND ((@I" +
                "sNull_YETKILISTATU = 1 AND [YETKILISTATU] IS NULL) OR ([YETKILISTATU] = @Origina" +
                "l_YETKILISTATU)) AND ((@IsNull_YETKILIADSOYAD = 1 AND [YETKILIADSOYAD] IS NULL) " +
                "OR ([YETKILIADSOYAD] = @Original_YETKILIADSOYAD)) AND ((@IsNull_YETKILITC = 1 AN" +
                "D [YETKILITC] IS NULL) OR ([YETKILITC] = @Original_YETKILITC)) AND ((@IsNull_SEK" +
                "TOR = 1 AND [SEKTOR] IS NULL) OR ([SEKTOR] = @Original_SEKTOR)) AND ((@IsNull_TE" +
                "LEFON1 = 1 AND [TELEFON1] IS NULL) OR ([TELEFON1] = @Original_TELEFON1)) AND ((@" +
                "IsNull_TELEFON2 = 1 AND [TELEFON2] IS NULL) OR ([TELEFON2] = @Original_TELEFON2)" +
                ") AND ((@IsNull_TELEFON3 = 1 AND [TELEFON3] IS NULL) OR ([TELEFON3] = @Original_" +
                "TELEFON3)) AND ((@IsNull_MAIL = 1 AND [MAIL] IS NULL) OR ([MAIL] = @Original_MAI" +
                "L)) AND ((@IsNull_FAX = 1 AND [FAX] IS NULL) OR ([FAX] = @Original_FAX)) AND ((@" +
                "IsNull_IL = 1 AND [IL] IS NULL) OR ([IL] = @Original_IL)) AND ((@IsNull_VERGIDAI" +
                "RE = 1 AND [VERGIDAIRE] IS NULL) OR ([VERGIDAIRE] = @Original_VERGIDAIRE)));\r\nSE" +
                "LECT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON2" +
                ", TELEFON3, MAIL, FAX, IL, VERGIDAIRE FROM TBL_FIRMALAR WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, AD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON" +
                "2, TELEFON3, MAIL, FAX, IL, VERGIDAIRE FROM dbo.TBL_FIRMALAR";
        ...
        public virtual int Insert(string AD, string YETKILISTATU, string YETKILIADSOYAD, string YETKILITC, string SEKTOR, string TELEFON1, string TELEFON2, string TELEFON3, string MAIL, string FAX, string IL, string VERGIDAIRE) {
            if ((AD == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_YETKILITC == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((string)(Original_YETKILITC));
            }
            if ((Original_SEKTOR == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((string)(Original_SEKTOR));
            }
            if ((Original_TELEFON1 == null)) {
